...
if st.session_state.page=="certs":
	...
	cols=st.columns(3)
	cols[0].image("./certificados/V_Simposio_IA.png")
	cols[0].write(f"<p style='text-align: center'> {message['VsimpIA'][lgg]} </p>", unsafe_allow_html=True)
	cols[1].image("./certificados/intro_to_XR.png")
	cols[1].write(f"<p style='text-align: center'> {message['xrintro'][lgg]} </p>", unsafe_allow_html=True)
	cols[2].image("./certificados/complex_analysis.png")
	cols[2].write(f"<p style='text-align: center'> {message['complex'][lgg]} </p>", unsafe_allow_html=True)
